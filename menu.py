...
class RotateButton(Button):
    """ Class that store data for buttons that could take one value from finite list (Ex. game modes) """
...
class BaseMenu(Frame):
    def __init__(self, buttons, menu_id, norm_color="#b9b9b9", dis_color="#2b2b2b"):
        ...
        for text, funcs in buttons:
            ...
            b.bind("<Enter>", self.swap_active)  # triggers when mouse entered on this object
