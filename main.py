...
# TODO's
# - add scale - DONE
# - add music - it requires additional libraries (pygame)
# - add settings
# - - theme			- +-
# - - sound on/off	- DEL (in Linux python don't have built-in packages for this)
# - - screen size	- DONE
# - startup menu
# - - play standart		- DONE
...
# - options menu (with size, theme, crazy params) - DONE
# - add comments - +-
...
class Game:
    ...
    def __init__(self):
        ...
        # 3 - <del>CRAZIEST</del> funniest choice ever. Buffs appeared 1 TIME A 0.3 S
        # 4 - epileptic
    ...
    def main(self):
        if not self.game_stopped:
            ...
            if self.vs_bot:
                self.left_pad.move(self.c.get_y_center(self.ball.id), self.buffs.l_pad_speed_up)
            else:
    ...
    def print_help(self):
        # TODO!! Print it on the main window
        print("Welcome to the F(unny)Pong")
        print()
        ...
        print("\t\t\t<Best> is the best - In My Humble Opinion")
